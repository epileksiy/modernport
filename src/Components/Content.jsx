            ...
            <div className="h-screen w-full">
                <div className="h-1/3 w-full">
                    <div className="z-100 landscape:lg:left-3/4 p-4 absolute flex flex-row landscape:lg:flex-col landscape:flex-row landscape:left-1/2 flex-wrap">
                        ...
                        <div className="p-2 w-1/2 md:w-auto text-md sm:text-xl md:text-xl font-semibold text-white flex flex-row items-center justify-center lg:justify-center md:justify-start">
                        ...
                        <a className='ml-5 cursor-pointer' href="https://t.me/gigarussian">@gigarussian</a>
                        </div>
                ...
                <div className="h-auto w-full p-5 lg:p-10 flex justify-center relative projectsdiv z-1">
                    ...
                    <div className=" w-full md:w-1/2 lg:w-3/4 xl:w-1/3 z-10 h-full rounded-md p-2 lg:p-10 mb-4 ">
                        ...
                        <div className="w-full h-auto bg-white rounded-md mt-10">
                            ...
                            <div className="h-1/4   p-4">
                                <p className='text-2xl lg:text-3xl font-semibold text-black'>Fortnite-style portfolio site</p>
                                <p className='text-1xl lg:text-2xl font-semibold text-gray-600 mb-5'>Креативный сайт-портфолио на игровую тематику / ThreeJs + React + Router</p>
                        ...
                        <div className="w-full h-auto text-center text-white font-semibold text-2xl md:text-3xl mt-24 uppercase z-100">
                            <p>"HELLOWORLD." 2022</p>
